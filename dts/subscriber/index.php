          ...
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              <div class="row">
                ...
                <div><h6>.....Location</h6></div>
                </div>
              </div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="dumo.php">
              <span class="float-left">enter location</span>
              <span class="float-right">
                <i class="fas fa-arrow-circle-right"></i>
              </span>
            </a>
